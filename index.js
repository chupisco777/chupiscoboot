	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Olá @${num.split('@')[0]}\nBem vindo ao grupo *${mdata.subject}*\nPor favor seja igual o chupisco❤️`
		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '⚠️ Este comando só pode ser usado pelo chupisco dono do bot! 😂',
			...
			const ownerNumber = ["554497335470@s.whatsapp.net"] // replace this with your number
